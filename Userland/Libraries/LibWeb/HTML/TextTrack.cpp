...
Bindings::TextTrackKind text_track_kind_from_string(String value)
{
    ...
    if (value.is_empty() || "subtitles"sv.equals_ignoring_ascii_case(value)) {
        return Bindings::TextTrackKind::Subtitles;
    }
    if ("captions"sv.equals_ignoring_ascii_case(value)) {
        return Bindings::TextTrackKind::Captions;
    }
    if ("descriptions"sv.equals_ignoring_ascii_case(value)) {
        return Bindings::TextTrackKind::Descriptions;
    }
    if ("chapters"sv.equals_ignoring_ascii_case(value)) {
        return Bindings::TextTrackKind::Chapters;
    }
    if ("metadata"sv.equals_ignoring_ascii_case(value)) {
